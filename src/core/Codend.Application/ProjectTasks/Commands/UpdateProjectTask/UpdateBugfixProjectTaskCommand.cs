...
public sealed record UpdateBugfixProjectTaskCommand(
    ...
    BugfixProjectTaskUpdateProperties UpdateTaskProperties
) : ICommand, IUpdateProjectTaskCommand<BugfixProjectTaskUpdateProperties>;

public class UpdateBugfixProjectTaskCommandHandler :
    AbstractUpdateProjectTaskCommandHandler<
        UpdateBugfixProjectTaskCommand,
        BugfixProjectTask,
        BugfixProjectTaskUpdateProperties>
{
