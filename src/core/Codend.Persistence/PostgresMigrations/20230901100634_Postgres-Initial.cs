...
namespace Codend.Persistence.PostgresMigrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Deleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    VersionName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    VersionTag = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ReleaseDate = table.Column<DateTime>(type: "timestamp(0) with time zone", precision: 0, nullable: false),
                    Changelog = table.Column<string>(type: "character varying(3000)", maxLength: 3000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    DeletedOnUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Deleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssignedToSprintsId = table.Column<Guid>(type: "uuid", nullable: false),
                    SprintProjectTasksId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SprintProjectTask", x => new { x.AssignedToSprintsId, x.SprintProjectTasksId });
                    table.ForeignKey(
