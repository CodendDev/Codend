...
namespace Codend.Persistence.Postgres.Migrations
{
    ...
    [Migration("20230912065325_NonAbstract-ProjectTask")]
    partial class NonAbstractProjectTask
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Codend.Domain.Entities.ProjectTaskBase", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ProjectTaskBase");
            ...
            modelBuilder.Entity("SprintProjectTask", b =>
                {
                    b.Property<Guid>("ProjectTaskBaseId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("SprintId")
                        .HasColumnType("uuid");

                    b.HasKey("ProjectTaskBaseId", "SprintId");
            ...
            modelBuilder.Entity("Codend.Domain.Entities.ProjectTask.Bugfix.BugfixProjectTask", b =>
                {
                    b.HasBaseType("Codend.Domain.Entities.ProjectTaskBase");
            ...
            modelBuilder.Entity("Codend.Domain.Entities.ProjectTaskBase", b =>
                {
                    ...
                    b.OwnsOne("Codend.Domain.ValueObjects.ProjectTaskDescription", "Description", b1 =>
                        {
                            b1.Property<Guid>("ProjectTaskBaseId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("ProjectTaskBaseId");

                            b1.ToTable("ProjectTask");

                            b1.WithOwner()
                                .HasForeignKey("ProjectTaskBaseId");
                        });
            ...
            modelBuilder.Entity("SprintProjectTask", b =>
                {
                    b.HasOne("Codend.Domain.Entities.ProjectTaskBase", null)
                        .WithMany()
                        .HasForeignKey("ProjectTaskBaseId")
